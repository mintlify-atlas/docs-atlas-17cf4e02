---
title: Pages
description: An introduction to Astro pages, file-based routing, and how pages work in your Astro project.
---
...
- `.astro` - Astro pages
- `.md` - Markdown pages
- `.mdx` - MDX pages (with the MDX Integration installed)
- `.html` - HTML pages
- `.js`/`.ts` - Endpoints
...
```astro title="src/pages/index.astro" {2,4,6}
---
...
Page files that can export a value (e.g. `.astro` and `.mdx`, but not `.md`) can be marked as partials.

```astro title="src/pages/partial.astro" {2}
---
